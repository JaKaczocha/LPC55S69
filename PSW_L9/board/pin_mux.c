...
pin_labels:
- {pin_num: '54', pin_signal: PIO0_0/FC3_SCK/CTIMER0_MAT0/SCT_GPI0/SD1_CARD_INT_N/SECURE_GPIO0_0/ACMP0_A, label: SW, identifier: SW}
...
void BOARD_InitADCPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITADCPINS_SW_GPIO, BOARD_INITADCPINS_SW_PORT, BOARD_INITADCPINS_SW_PIN, &SW_config);
