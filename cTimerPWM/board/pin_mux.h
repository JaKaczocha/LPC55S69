...
/*! @name PIO1_4 (number 1), R78/P18[5]/LEDR/PWM_ARD
  @{ */
#define BOARD_INITCTIMEROUTS_LED_BLUE_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITCTIMEROUTS_LED_BLUE_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_INITCTIMEROUTS_LED_BLUE_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                                               /* @} */
 ...
 *
 */
void BOARD_InitCTIMEROuts(void); /* Function assigned for the Cortex-M33 (Core #0) */
