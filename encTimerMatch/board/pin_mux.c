...
- pin_list:
  ...
  - {pin_num: '89', peripheral: PINT, signal: 'PINT, 2', pin_signal: PIO0_6/FC3_SCK/CT_INP13/CTIMER4_MAT0/SCT_GPI6/SECURE_GPIO0_6, identifier: ''}
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitENCPinc
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M33 (Core #0) */
void BOARD_InitENCPinc(void)
{
    ...
    GPIO_PinInit(BOARD_INITENCPINC_SIB_GPIO, BOARD_INITENCPINC_SIB_PORT, BOARD_INITENCPINC_SIB_PIN, &SIB_config);
    ...
    GPIO_PinInit(BOARD_INITENCPINC_SIA_GPIO, BOARD_INITENCPINC_SIA_PORT, BOARD_INITENCPINC_SIA_PIN, &SIA_config);
    ...
    GPIO_PinInit(BOARD_INITENCPINC_SW_GPIO, BOARD_INITENCPINC_SW_PORT, BOARD_INITENCPINC_SW_PIN, &SW_config);
    ...
    /* PIO0_6 is selected for PINT input 2 */
    INPUTMUX_AttachSignal(INPUTMUX, 2U, kINPUTMUX_GpioPort0Pin6ToPintsel);
