...
void BOARD_InitPMODPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITPMODPINS_SIB_GPIO, BOARD_INITPMODPINS_SIB_PORT, BOARD_INITPMODPINS_SIB_PIN, &SIB_config);
    ...
    GPIO_PinInit(BOARD_INITPMODPINS_SIA_GPIO, BOARD_INITPMODPINS_SIA_PORT, BOARD_INITPMODPINS_SIA_PIN, &SIA_config);
    ...
    GPIO_PinInit(BOARD_INITPMODPINS_SW_GPIO, BOARD_INITPMODPINS_SW_PORT, BOARD_INITPMODPINS_SW_PIN, &SW_config);
