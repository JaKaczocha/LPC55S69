...
/* Symbols to be used with GPIO driver */
#define BOARD_INITPMODPINS_ENC_B_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPMODPINS_ENC_B_GPIO_PIN_MASK (1U << 2U) /*!<@brief GPIO pin mask */
#define BOARD_INITPMODPINS_ENC_B_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPMODPINS_ENC_B_PIN 2U                   /*!<@brief PORT pin number */
#define BOARD_INITPMODPINS_ENC_B_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                                          /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITPMODPINS_ENC_A_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPMODPINS_ENC_A_GPIO_PIN_MASK (1U << 3U) /*!<@brief GPIO pin mask */
#define BOARD_INITPMODPINS_ENC_A_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPMODPINS_ENC_A_PIN 3U                   /*!<@brief PORT pin number */
#define BOARD_INITPMODPINS_ENC_A_PIN_MASK (1U << 3U)      /*!<@brief PORT pin mask */
                                                          /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_INITPMODPINS_ENC_S_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPMODPINS_ENC_S_GPIO_PIN_MASK (1U << 6U) /*!<@brief GPIO pin mask */
#define BOARD_INITPMODPINS_ENC_S_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPMODPINS_ENC_S_PIN 6U                   /*!<@brief PORT pin number */
#define BOARD_INITPMODPINS_ENC_S_PIN_MASK (1U << 6U)      /*!<@brief PORT pin mask */
                                                          /* @} */
