...
/* Symbols to be used with GPIO driver */
#define BOARD_INITLEDSPINS_S1_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITLEDSPINS_S1_GPIO_PIN_MASK (1U << 5U) /*!<@brief GPIO pin mask */
#define BOARD_INITLEDSPINS_S1_PORT 0U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITLEDSPINS_S1_PIN 5U                   /*!<@brief PORT pin number */
#define BOARD_INITLEDSPINS_S1_PIN_MASK (1U << 5U)      /*!<@brief PORT pin mask */
                                                       /* @} */
