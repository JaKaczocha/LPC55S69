...
void BOARD_InitPMODPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITPMODPINS_ENC_B_GPIO, BOARD_INITPMODPINS_ENC_B_PORT, BOARD_INITPMODPINS_ENC_B_PIN, &ENC_B_config);
    ...
    GPIO_PinInit(BOARD_INITPMODPINS_ENC_A_GPIO, BOARD_INITPMODPINS_ENC_A_PORT, BOARD_INITPMODPINS_ENC_A_PIN, &ENC_A_config);
    ...
    GPIO_PinInit(BOARD_INITPMODPINS_ENC_S_GPIO, BOARD_INITPMODPINS_ENC_S_PORT, BOARD_INITPMODPINS_ENC_S_PIN, &ENC_S_config);
